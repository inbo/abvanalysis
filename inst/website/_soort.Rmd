...
Op basis van jaarlijkse gegevens zien we een gemiddeld `r deze_lineair$tekst[!deze_lineair$cycle]` `r deze_lineair$jaarlijks[!deze_lineair$cycle]` per jaar of `r deze_lineair$looptijd[!deze_lineair$cycle]` over de volledige looptijd van het meetnet.
Deze trend is `r deze_lineair$interpretatie[!deze_lineair$cycle]`.

Op basis van driejaarlijkse gegevens zien we een gemiddeld `r deze_lineair$tekst[deze_lineair$cycle]` `r deze_lineair$jaarlijks[deze_lineair$cycle]` per jaar of `r deze_lineair$looptijd[deze_lineair$cycle]` over de volledige looptijd van het meetnet.
Deze trend is `r deze_lineair$interpretatie[deze_lineair$cycle]`.
