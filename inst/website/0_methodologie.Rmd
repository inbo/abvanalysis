...
```{r inspanning, fig.cap = "Overzicht van de effectieve monitoringsinspanning. Elk punt is een hok dat onderzocht is in een bepaald jaar. De horizontale lijnen verbinden het eerste en meest recente bezoek aan eenzelfde hok.", fig.height = 10}
effort %>%
  arrange(.data$year) %>%
...
Daarom moeten we priors specifiëren voor de (hyper-)parameters.
...
Bijvoorbeeld als het interval volledig tussen de onder- en bovengrens ligt.
...
(ref:regels) Overzicht van de benamingen van de tien effectklasses met hun afkorting en de regels. $R$: referentie, $L$: ondergrens, $B$: bovengrens, $l$: ondergrens van het 90% interval, $b$: bovengrens van het 90% interval. $L < R < B$ en $l < b$.
