...
paste0(
  ...
  "(../methodologie/voorstelling.html#sec-trendklasse) ",
  "zorgen voor de opdeling van de wijzigingen in [klassen]",
  "(../methodologie/voorstelling.html#sec-trendklasse) in stappen van 30%%. ",
  "Beweeg met de muis over de grafiek om de indeling zichtbaar te maken."
) |>
...
c(
  index_year$data(withFilter = FALSE)$lower_confidence_limit,
  threshold,
  index_year$data(withFilter = FALSE)$upper_confidence_limit,
  -threshold
) |>
