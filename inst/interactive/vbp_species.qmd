...
paste0(
  ...
  "(https://inbo.github.io/abv-rapport/2023/methodologie/",
  "voorstelling.html#sec-onzekerheid) in stappen van 5%%."
) |>
...
paste0(
  ...
  "De [referentielijnen]",
  "(https://inbo.github.io/abv-rapport/2023/methodologie/",
  "voorstelling.html#sec-trendklasse) ",
...
Onderstaande grafieken zijn als [interactieve grafieken]({{url}}/soort/{{label}}.html) beschikbaar in de online versie het [rapport]({{url}}) over de toestand van de Algemene Broedvogels in Vlaanderen.
In die versie kan je tevens het nodige cijfermateriaal [downloaden]({{url}}/methodologie/reproduceerbaarheid.html#downloadbaar-cijfermateriaal) om deze figuren te reproduceren.
