...
update_geom_defaults(
  "point",
  list(size = ifelse(knitr::is_html_output(), 4, 2))
)
...
effort |>
  ...
  transmute(
    ...
    year2 = lead(.data$year),
    year3 = lead(.data$year2),
    year4 = lead(.data$year3),
    year5 = lead(.data$year4),
    year6 = lead(.data$year5),
